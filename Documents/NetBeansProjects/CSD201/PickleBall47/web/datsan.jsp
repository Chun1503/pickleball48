<%-- 
    Document   : datsan
    Created on : Mar 3, 2025, 5:45:08 AM
    Author     : Minh Trung
--%>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-5">
            <div class="booking-form p-4 shadow" data-aos="fade-right" data-aos-delay="100">
                <h2 class="text-center mb-3">Thông tin sân bóng PickleBall</h2>                
                <form>
                    <div class="mb-3">
                        <label for="fieldName" class="form-label">Tên Sân</label>
                        <input type="text" class="form-control" id="fieldName" value="${requestScope.ffs.pickleBallField.name}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="fieldType" class="form-label">Loại Sân</label>
                        <input type="text" class="form-control" id="fieldType" value="Sân gồm ${requestScope.ffs.pickleBallField.typeofPickleBallField} người/ Đội" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="price" value="${requestScope.ffs.pickleBallField.price} VNĐ" readonly>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-5">
            <div class="booking-info p-4 shadow" data-aos="fade-left" data-aos-delay="100">
                <h2 class="text-center mb-3">Thông tin đặt sân PickleBall</h2>
                <form action="datsan" method="get" id="bookingForm">                            
                    <div class="mb-3">
                        <label for="fieldBooked" class="form-label">Tên sân cần đặt</label>
                        <input type="text" class="form-control" id="fieldBooked" value="${requestScope.ffs.pickleBallField.name}" readonly>
                    </div>
                    <div class="mb-3">
