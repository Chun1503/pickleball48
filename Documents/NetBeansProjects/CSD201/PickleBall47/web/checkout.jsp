                ...
                <div class="row">
                            ...
                            <div class="payment-methods">
                                <div class="payment-method">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="paymentMethod" id="vnpay" value="bank_transfer" required="">
                                        <label class="form-check-label" for="vnpay">
                                            <div class="payment-method-title">VNPay</div>
                                            <div class="payment-method-description">Thanh toán qua VNPay.</div>
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="order-summary">
                                    ...
                                    <div class="order-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="order-item-quantity">Unit Price: <fmt:formatNumber value="${item.price}" type="currency" currencyCode="VND" maxFractionDigits="0"/></div>
                                            </div>
                                        </div>
                            ...
                            <input type="hidden" value="${subtotal}" name="cartTotal" />
