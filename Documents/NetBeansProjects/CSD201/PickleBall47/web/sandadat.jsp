...
<html>
    <head>
        ...
        <link href="css/style_Chun.css" rel="stylesheet">
    </head>
                                        ...
                                        <tr class="alert" role="alert" data-toggle="collapse" data-target="#details" aria-expanded="false" aria-controls="details">
                                            ...
                                            <td class="details collapsed" >
                                                <div class="text-start">
                                                    <div>Tên sân: ${list.pickleBallFieldSchedule.pickleBallField.name}</div>
                                                    <div>Loại sân: Sân dành cho ${list.pickleBallFieldSchedule.pickleBallField.typeofPickleBallField} người/ đội</div>
                                                    <div>Thời gian: ${list.pickleBallFieldSchedule.startTime} - ${list.pickleBallFieldSchedule.endtime}</div>
                                                    <div>Giá cả: ${list.pickleBallFieldSchedule.pickleBallField.price} VNĐ</div>
                                            ...
                                            <c:if test="${list.status == 1 || list.status == 2}">
                                                <td>
                                                    <a href="javascript:void(0);" class="btn btn-danger" onclick="confirmCancel(${list.IDRegisteredPickleBallField})">Hủy sân</a>
                                                </td>
                                                <td>
                                                    <a href="updatesandadat?IDrff=${list.IDRegisteredPickleBallField}" class="btn btn-secondary">Update</a>
                                                </td>
                                            </c:if>
                                        </tr> 
                                    </c:forEach>
                    ...
                    <div class="col-lg-4 col-md-6 footer-about">
                        <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                            <a href="index.html" class="navbar-brand">
                                <h1 class="m-0 text-white"><i class="fa fa-user-tie me-2"></i>PickleBall 47</h1>
                            </a>
