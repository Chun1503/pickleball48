    ...
    <body>
        ...
        <div class="container order-history-container">
            <div class="od-main">
                ...
                <div class="main-table">
                    <div class="filter row grid gap-2">
                        <input class="form-control col search-input" type="date" name="dateFilter" />
                        <select name="statusFilter" class="form-control col search-input">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <c:forEach items="${oList}" var="o">
                                <tr>
                                    <td>${o.order_id}</td>
                                    <td><fmt:formatNumber value="${o.total_price}" type="currency" currencyCode="VND" maxFractionDigits="0"/></td>
                                    <td>${o.status}</td>
                                    <td>${o.created_at}</td>
                                    <td>
                                        <a href="orderdetail?oid=${o.order_id}"<button>Detail</button></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    ...
                    <div class="paging">
                        <div class="d-flex justify-content-between align-items-center mt-4 pagination-custom">
                            <span id="pageIndicator" class="text-dark">${itemFrom} - ${itemTo} of ${totalItems} Items</span>
                            <div class="d-flex gap-3">
                                <i id="prevPage" class="fas fa-chevron-left text-dark fs-5" style="cursor: pointer;"></i>
                                <i id="nextPage" class="fas fa-chevron-right text-dark fs-5" style="cursor: pointer;"></i>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("select.search-input").on("input", updateURL);
