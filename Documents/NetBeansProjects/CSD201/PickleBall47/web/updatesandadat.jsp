                    ...
                    <div class="booking-form p-4 shadow" data-aos="fade-right" data-aos-delay="100">
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="fieldName" value="${requestScope.rff.pickleBallFieldSchedule.pickleBallField.name}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="fieldType" class="form-label">Loại Sân</label>
                                <input type="text" class="form-control" id="fieldType" value="Sân gồm ${requestScope.rff.pickleBallFieldSchedule.pickleBallField.typeofPickleBallField} người/ Đội" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="startTime" class="form-label">Thời gian bắt đầu</label>
                                <input type="text" class="form-control" id="startTime" value="${requestScope.rff.pickleBallFieldSchedule.startTime}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="endTime" class="form-label">Thời gian kết thúc</label>
                                <input type="text" class="form-control" id="endTime" value="${requestScope.rff.pickleBallFieldSchedule.endtime}"readonly>
                            </div>
                            <div class="mb-3">
                                <label for="price" class="form-label">Giá tiền</label>
                                <input type="text" class="form-control" id="price" value="${requestScope.rff.pickleBallFieldSchedule.pickleBallField.price} VNĐ" readonly>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="booking-info p-4 shadow" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <form action="updatesandadat" method="post">                            
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="fieldBooked" value="${requestScope.rff.pickleBallFieldSchedule.pickleBallField.name}" readonly>
                            </div>
                            <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="id" value="${requestScope.rff.IDRegisteredPickleBallField}" hidden="">
