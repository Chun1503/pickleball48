<%-- 
    Document   : updatesanbong
    Created on : Mar 14, 2025, 7:38:01 PM
    Author     : Minh Trung
--%>
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <a href="index1.jsp" class="navbar-brand mx-4 mb-3">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <!-- <a href="quanlydoibongthamgia_nam.jsp" class="dropdown-item">Quản lý đội bóng và danh sách cầu thủ</a> -->
                            <!-- <a href="quanlylichthidau_nam.jsp" class="dropdown-item">Quản lý lịch thi đấu</a> -->
                            
                            <!-- <a href="kiemduyetcacdoibongthamgiagiaidau_nam.jsp" class="dropdown-item">Kiểm duyệt các đội bóng tham gia</a> -->
                        </div>
                    </div>
        ...
        <div class="content">
            ...
            <form action="updatesanbong" method="post" enctype="multipart/form-data">
                <input value="${pickleBallField.IDPickleBallField}" hidden="" name="fieldID">
                <label for="fieldName" class="form-label">Tên sân:</label>
                <input type="text" class="form-control"id="fieldName" name="fieldName" value="${pickleBallField.name}" >

                <br>

                <label for="fieldType" class="form-label">Loại sân:</label>
                <input type="number" class="form-control" id="fieldType" name="fieldType" value="${pickleBallField.typeofPickleBallField}" >

                <br>

                <label for="fieldPrice" class="form-label">Giá tiền (VNĐ):</label>
                <input class="form-control" type="number" id="fieldPrice" name="fieldPrice" value="${pickleBallField.price}" >
