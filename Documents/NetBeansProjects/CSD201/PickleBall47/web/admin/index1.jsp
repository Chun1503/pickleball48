<%-- 
    Document   : index1
    Created on : Mar 12, 2025, 5:27:54 AM
    Author     : Minh Trung
--%>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <form method="get" action="Dashboard">
                                <select name="year" onchange="this.form.submit()">
                                    ...
                                    <option value="2025" ${param.year=="2024"?"Selected":""}>2024</option>
                                    ...
                                    <option value="2028" ${param.year=="2028"?"Selected":""}>2028</option>
                                    <option value="2029" ${param.year=="2029"?"Selected":""}>2029</option>
                                </select>
                            </form>
                        </div>
                        <div class="row">
                ...
                <script>
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                    label: 'Revenue in ${param.year==null?"2025":param.year} (VND)',
                                    data: [<c:forEach var="t" items="${st}">
                               ${t.revenue},            
                            </c:forEach>],
                                    borderWidth: 1
                                }]
                    ...
                    <div class="bg-light rounded-top p-4">
                        <div class="row">
                            <div class="col-12 col-sm-6 text-center text-sm-start">
                                <a href="index1.html">PickleBall47</a>, All Right Reserved. 
                            </div>                        
                        </div>
                    </div>
                </div>
