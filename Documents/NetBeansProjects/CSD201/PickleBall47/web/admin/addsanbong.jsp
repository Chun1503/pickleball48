<%-- 
    Document   : addsanbong
    Created on : Mar 14, 2025, 7:22:44 PM
    Author     : Minh Trung
--%>
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <form action="addsanbong" method="post" enctype="multipart/form-data">                
                ...
                <input type="text" class="form-control"id="fieldName" name="fieldName" minlength="0" maxlength="100" required >
                ...
                <input class="form-control" type="number" id="fieldPrice" min="0" max="100000000" name="fieldPrice" required="" >
