<%-- 
    Document   : xacnhanyeucau
    Created on : Mar 14, 2025, 9:11:53 AM
    Author     : Minh Trung
--%>
            ...
            <div class="content">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody> 
                                            <c:forEach var="list" items="${requestScope.listBill1}"> 
                                                <tr id="${list.IDBill}">
                                                    <td>${list.registeredPickleBallField.date}</td>
                                                    <td>
                                                        <div class="text-start">
                                                            <div>Tên sân:${list.registeredPickleBallField.pickleBallFieldSchedule.pickleBallField.name} </div>
                                                            <div>Loại sân: Sân ${list.registeredPickleBallField.pickleBallFieldSchedule.pickleBallField.typeofPickleBallField} người/ đội</div>
                                                            <div>Thời gian:${list.registeredPickleBallField.pickleBallFieldSchedule.startTime}-${list.registeredPickleBallField.pickleBallFieldSchedule.endtime}</div>
                                                            <div>Giá cả: ${list.registeredPickleBallField.pickleBallFieldSchedule.pickleBallField.price} VNĐ</div>
                                                            <div>Tiền cọc: ${list.registeredPickleBallField.deposit} VNĐ</div>
                                                        </div>
                                                    </td>
                                                    <td>${list.registeredPickleBallField.name}</td>
                                                    <td>${list.registeredPickleBallField.phoneNumber}</td>
                                                    <td>${list.registeredPickleBallField.note}</td> 
                                                    <c:if test="${list.registeredPickleBallField.status==2}">
                                                        <td>
                                                            Duyệt sân
                                                        </td>
                                                        <td id="duyet">
                                                    ...
                                                    <c:if test="${list.registeredPickleBallField.status==4}">
                                                        <td >
                                                            Hủy sân
                                                        </td> 
                                                        <td id="huy">
                ...
                <script>
                    ...
                    $(document).on("click", ".btn1", function () {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "http://localhost:8080/PickleBall47/admin/xulyyeucau",
                    ...
                    <div class="bg-light rounded-top p-4">
                        <div class="row">
                            <div class="col-12 col-sm-6 text-center text-sm-start">
                                <a href="index.jsp">PickleBall47</a>, All Right Reserved. 
                            </div>                        
                        </div>
                    </div>
                </div>
